...
<html lang="en">
  <head>
    <title>Emirate &mdash; Sabun Bidara</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black mb-0">Emirate</a></h1>
          </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            ...
            <h2 class="section-title mb-3">Reseller</h2>
          </div>
        </div>
        <div class="row">
            ...
            <form action="#" class="p-5 bg-white">              
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="pnumber" id="pnumber" class="form-control rounded-0">
                </div>
              </div>
